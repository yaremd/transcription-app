...
#ifndef LOCALSCRIBE_SWIFT_H
#define LOCALSCRIBE_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="LocalScribe",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class SCStream;
/// Captures system-wide output audio (the <em>other</em> participants in a call, or
...
SWIFT_CLASS("_TtC11LocalScribe19SystemAudioCapturer")
@interface SystemAudioCapturer : NSObject <SCStreamOutput>
